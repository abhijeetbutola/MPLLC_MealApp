  ...
  return (
    <div style={styles.container}>
      ...
      <p style={styles.paragraph}>
        ...
        accessible digital experiences. I have a strong background in developing
        user interfaces, integrating APIs, and ensuring application performance.
      </p>
      <div>
        ...
        <p style={styles.paragraph}>
          ...
          fingertips. This project utilizes a free public API from TheMealDB to
          fetch a variety of meals and offers a range of features to make meal
          selection enjoyable and personalized.
        </p>
        ...
        <ul style={styles.list}>
          ...
          <li>
            About Me Page: Personal comments and information about the creator.
          </li>
          <li>Menu Page: Browse through different meal categories.</li>
          <li>
            Meals Page: View detailed information about meals, including images
            and names, and add or remove meals from your favourites list.
          </li>
          <li>
            Favorite Meals Page: See all your favourite meals with the option to
            remove them.
          </li>
          <li>
